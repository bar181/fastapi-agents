# agents/agent_hello.py
from fastapi import APIRouter, Query
from typing import Dict, Any
from .gemini_agent import GeminiAgent
from .openai_agent import OpenAIAgent

class AgentHelloAgent:
    """
    Agent Hello Agent
    ---------------
    ...
    Usage (standalone - for testing):
        # In a Python shell:
        from agents import agent_hello
        agent = agent_hello.AgentHelloAgent()
...
def register_routes(router: APIRouter):
    """Registers the agent hello agent's route with the provided APIRouter."""
    
    agent = AgentHelloAgent()
    
    @router.get("/agent-hello", summary="Send prompt to selected LLM", tags=["LLM Agents"])
